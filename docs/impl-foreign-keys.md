...
- **Transactions and MVCC are built** (`docs/txn.md` T01–T14), so §4's
...
**Amendment (FK-M1).** `docs/txn.md` is built, which makes this
...
directly onto the wire's `retryable` bit, which `docs/protocol.md` §11
