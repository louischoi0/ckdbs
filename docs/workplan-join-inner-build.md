...
**JB1–JB5 and JB7 are built (2026-08-20); JB6 is not** (it was in
flight in a separate worktree when JB7 landed, and the two are
independent — JB7 reads counters JB3/JB4 already collect and adds no
executor state). JB8's measurement is discharged by
`bench/results-scenario3-library.md` §7f; its workplan row below is the
remaining paperwork. The sanction is
