...
Owner doc for the **post-fold consumers**. Retracts `docs/feat-aggregate.md`
...
output" row) and `docs/parser-v2.md` I11's aggregated-tail sentence.
...
`docs/feat-aggregate.md` (AG7 retracted in place with the date, §2's table,
§8's "what v1 is not", §10's open item closed), `docs/workplan-order-by.md`
(the refusal table's aggregated row), `docs/parser-v2.md` I11 and the J2
paragraph naming HAVING, `manual/sql/sql.md` (both passages),
`docs/client-manual.md`, and this repo's `CLAUDE.md` milestone row. A
