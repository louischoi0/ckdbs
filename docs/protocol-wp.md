...
File: `docs/client-manual.md`. Replace the newline-protocol description with KWP/1: connect, handshake, extended flow, streaming, txn/durability, errors, cancel. Move the newline protocol to an appendix titled "Loopback debug surface" with its off-by-default flag documented.
