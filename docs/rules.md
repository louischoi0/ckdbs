...
## 2. Page Buffer Access `[CONFIRMED]`
...
## 4. Deterministic Testability `[CONFIRMED]`
...
- Fresh, idiomatic modern C++ codebase: port ideas from the legacy kernel-module C code, never copy it wholesale.
