...
workplan: `docs/workplan-bulk-insert.md` (to be written from this spec).
Consistent with `docs/protocol.md`, `docs/wal.md`, `docs/feat-assertion.md`,
`docs/feat-index.md`, `docs/feat-cabin.md`, `docs/spec-eviction.md`,
`docs/rules.md`.
...
reserved offline re-key pass (`docs/keystoneid-invariant.md`), test-harness
seeding (`docs/workplan-testing.md` S-1), benchmark preparation, and
