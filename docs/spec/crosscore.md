...
- Every rejected cross-core write increments a per-core observability
  ...
  anything refused before resolution at all. The owner-core refusal —
  `IndexBuildPending`, and `RelationWriteRightsPending` beside it until
