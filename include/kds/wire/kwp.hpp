...
// src/wire/frame_codec.cpp (docs/protocol-wp.md P06) - the same
...
//
// Frame layout (docs/protocol.md §2): every message in both directions is
...
// Encoding is little-endian end to end (docs/protocol.md D5) regardless
...
// ---- Frame header (docs/protocol.md §2) ------------------------------------
...
// violation (bad length, resync impossible - docs/protocol.md §2).
...
// ---- Frame catalog (docs/protocol.md §4) -----------------------------------
...
// ---- Capabilities (docs/protocol.md §3) ------------------------------------
...
// define a detail taxonomy yet (skeleton only, per docs/protocol-wp.md P05).
...
// ---- Handshake payloads (docs/protocol.md §3) ------------------------------
...
// lands with the handshake state machine (docs/protocol-wp.md P07,
...
// ---- Frame codec (docs/protocol-wp.md P06; bodies in frame_codec.cpp) -----
...
// codec. The zero-allocation steady-state discipline docs/sched.md and
// docs/protocol-wp.md's standing instructions require is a property of
// the *reactor integration* (docs/protocol-wp.md P13), not this class in
...
public:
    ...
    // per docs/protocol.md §2, "on framing-level corruption where resync
