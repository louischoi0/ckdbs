...
| AM-R1, AM-R3, AM-R5; AM-S0..S6 not started | `instructions/v3.0.0/workorder-am-m1-shared-pool.md:141-153,162-173,187-193,229-233` | as quoted; the row table still reads "not started" although `git log` carries two AM-S0 commits (`a2cd96a`, `30e0377`) — the table lags the work, which is AM's to fix |
