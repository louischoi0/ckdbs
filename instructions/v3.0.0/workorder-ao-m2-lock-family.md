...
6-8. `FkProbeRigTest.AChildResumedFromItsProbe*` - a parent committed on
...
The suite ran 3356/3356 green in 158.99 s on the tree that carries them.
...
R13's gate, the `DROP TABLE` wait on a positioned peer reader. It inherits
