...
| AM-S5 | done, as AW-S1 |
| AM-S6 | not started; AM-1 says why AL-S8 gates it, and `workorder-aw-m1-close.md` AW-S5 adds AN-S2 and the operator's host |
