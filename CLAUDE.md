...
| Buffer-pool eviction | EVT01/EVT02 partly, EVT03 (writeback) and EVT06 (scan ring) built; full CLOCK reclamation still gated on the `PageRef` migration — **planned 2026-08-13** (MG01-MG06, ~148 engine sites recounted, nothing built) | `docs/workplan-pageref.md`, `docs/spec-eviction.md`, `docs/workplan-eviction.md`, `docs/page.md` §3 |
