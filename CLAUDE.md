...
| Cross-core execution | P0, P1, P2, P6 (catalog half + CC7 decision + P6b handoff + P6c placement, all built 2026-08-10), P4 restriction half built — remaining: row-id leasing for peer INSERT, and the step pipeline itself (dispatch + the executor's coroutine conversion) | `docs/crosscore.md`, `docs/workplan-crosscore.md`, `docs/sched.md` |
