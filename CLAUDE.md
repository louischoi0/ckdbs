...
| Cross-core execution | P0, P1, P2, P6 catalog half, P4 restriction half built; **the P6 ownership decision is made (CC7, 2026-08-10: catalog-derived, flush-then-grant handoff)** — P6b/P6c and the pipeline itself remain | `docs/crosscore.md`, `docs/workplan-crosscore.md`, `docs/sched.md` |
