...
- **Cross-core** (`docs/crosscore.md` §9, `docs/sched.md` §10): the 2PC
  ...
  auxiliary placement under a split relation (each §6a gate's owner);
  the id-block interleave default.
