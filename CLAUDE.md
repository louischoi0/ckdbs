...
| Secondary indexes (multi-column, covering) | Built. No index-only scan, no `UNIQUE`. **The insert descent is not re-validated across cores** - two cores writing one index can misplace an entry (`docs/inflight/bugs/a-secondary-index-descent-is-not-revalidated-across-cores.md`, found by reading at AT-S12) | `docs/spec/index.md` |
