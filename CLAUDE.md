...
| Wire protocol KWP/1 | Frame codec only; the server speaks the newline text protocol. **Direct TLS built 2026-08-13**: TLS 1.3 at the transport seam below the protocol, `tls` config key, off by default | `docs/protocol.md`, `docs/protocol-wp.md`, `docs/client-manual.md` |
...
- **Protocol** (`docs/protocol.md`): frame/batch/timeout sizing;
  compression; flow control; the authorization model; SCRAM parameters
  (TLS mode was decided 2026-08-13: direct TLS, §1).
