...
| Physical optimizer, Part II: Cabin controller | PHY01-PHY07 built — the controller runs end to end (PHY04, 2026-08-10, over the EVT03/EVT06 substrate) with observability (PHY06, 2026-08-10: `SHOW CABIN_OPTIMIZER`, applied-action counters, ANALYZE's managed mark, the NoteExtended budget edge); PHY08 (E2E close-out) remaining | same docs, Part II / §II.1-§II.7 |
